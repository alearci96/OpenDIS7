...
{
    /// <summary>
    /// Enumeration values for Type2Parameter1Mode1InterrogatorStatus (der.iff.type.2.fop.param1, Parameter 1 - Mode 1
    /// Interrogator Status,
    /// section 8.3.2.2.2)
    ...
    [Serializable]
    [Flags]
    public enum Type2Parameter1Mode1InterrogatorStatus : ushort
    {
        /// <summary>

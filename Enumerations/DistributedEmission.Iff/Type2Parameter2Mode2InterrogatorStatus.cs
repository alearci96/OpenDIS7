...
{
    /// <summary>
    /// Enumeration values for Type2Parameter2Mode2InterrogatorStatus (der.iff.type.2.fop.param2, Parameter 2 - Mode 2
    /// Interrogator Status,
    /// section 8.3.2.2.3)
    ...
    [Serializable]
    [Flags]
    public enum Type2Parameter2Mode2InterrogatorStatus : ushort
    {
        /// <summary>

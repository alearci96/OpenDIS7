...
{
    /// <summary>
    /// Enumeration values for Type2Parameter3Mode3InterrogatorStatus (der.iff.type.2.fop.param3, Parameter 3 - Mode 3
    /// Interrogator Status,
    /// section 8.3.2.2.4)
    ...
    [Serializable]
    [Flags]
    public enum Type2Parameter3Mode3InterrogatorStatus : ushort
    {
        /// <summary>

...
{
    /// <summary>
    /// Enumeration values for ArealObjectStatePDUModificationField (env.obj.mod.areal, Areal Object State PDU Modification
    /// Field,
    /// section 12.1.3.3)
    ...
    {
        /// <summary>
        /// Set bit means 'Locations have been modified', reset bit means 'No locations have been modified'.
        /// </summary>
        [SuppressMessage("Microsoft.Naming", "CA1702:CompoundWordsShouldBeCasedCorrectly", Justification = "Due to SISO standardized naming.")]
        [SuppressMessage("Microsoft.Naming", "CA1704:IdentifiersShouldBeSpelledCorrectly", Justification = "Due to SISO standardized naming.")]
        [SuppressMessage("Microsoft.Naming", "CA1707:IdentifiersShouldNotContainUnderscores", Justification = "Due to SISO standardized naming.")]
